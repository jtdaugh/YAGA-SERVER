...
class YagaAppConf(
    ...
    SMS_INVITE_SUFFIX = config('SMS_INVITE_SUFFIX', default='Join in at www.yaga.video\n\nReply STOP to end video notifications.')
    SMS_VIDEO_BASE_URL = config('SMS_VIDEO_BASE_URL', default='www.yaga.video/v/')
    ...
    THIRD_RELEASE_CLIENT_VERSION = 300
